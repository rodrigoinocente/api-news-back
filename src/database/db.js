...
const likeCommentsConn = mongoose.createConnection(process.env.MONGODB_URI_LIKECOMMENTS);
...
export const LikeCommentModel = likeCommentsConn.model("LikeComment", LikeCommentSchema, "likes");
